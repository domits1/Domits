...
const PropertyDetailsScreen = ({route, navigation}) => {
  console.log(route);
  const accommodationId = route.params.property.id;
  ...
  useEffect(() => {
    FetchPropertyDetails(route.params.property.id)
      .then()
      .catch(error => {
    ...
    <SafeAreaView style={{flex: 1}}>
      <View style={styles.container}>
        ...
        <ScrollView style={styles.contentContainer}>
          <PropertyImagesView images={images} />

          <View style={styles.propertyDetailsContainer}>
            <PropertyMainDetailsView property={parsedAccommodation} />
            ...
            <View>
              <Text>
                Nights: €
                {Number(parsedAccommodation.Rent * amountOfNights).toFixed(2)}
              </Text>
              <Text>
                Cleaning fee: €{parsedAccommodation.CleaningFee.toFixed(2)}
              </Text>
              <Text>
                Service fee: €{parsedAccommodation.ServiceFee.toFixed(2)}
              </Text>
