      ...
      case 2:
        return (
          <View>
            ...
            <View style={styles.cardHolder}>
              {renderCard(0, '< 25m²', null, selectedCards[2] === 0, 0.8)}
              ...
              {renderCard(4, '> 100 m²', null, selectedCards[2] === 4, 1.3)}
            </View>
            <View style={styles.buttonHolder}>
              <TouchableOpacity
                style={styles.nextButtons}
        ...
        return (
          <View>
            ...
            <View style={styles.cardHolder}>
              ...
              {renderCard(2, '3', null, selectedCards[3] === 2, 1.2)}
              {renderCard(3, '4', null, selectedCards[3] === 3, 1.23)}
              {renderCard(4, '5 or more', null, selectedCards[3] === 4, 1.5)}
            </View>
            <View style={styles.buttonHolder}>
              <TouchableOpacity
                style={styles.nextButtons}
              ...
              <TouchableOpacity
                style={[
                  styles.nextButtons,
                  {
                    backgroundColor: areAllCardsSelected()
                      ? 'green'
                      : '#003366',
                ...
                onPress={
                  areAllCardsSelected() ? () => pageUpdater(page + 1) : null
                }
          ...
          <View>
            ...
            <View style={styles.infoHolder}>
              ...
              <Text style={styles.info}>
                Real Estate Type: {displayInfo(1)}
              </Text>
