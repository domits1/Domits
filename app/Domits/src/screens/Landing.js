      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.headerContainer}>
          <Text style={styles.header}>
            List your <Text style={styles.highlightText}>House</Text>
          </Text>
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.thirdHeader}>
            Hosting on <Text style={styles.highlightText}>Domits</Text> has
            never been <Text style={styles.highlightText}>easier</Text>.
          </Text>
          ...
          <Text style={styles.text}>
            Welcome your guests with a warm and personal touch.
          </Text>
          <Text style={styles.Numbers}>2.</Text>
          <Text style={styles.textBoldHostDomits}>Get paid</Text>
          <Text style={styles.text}>
            Enjoy fast, easy, and secure payments.
          </Text>
          <Text style={styles.Numbers}>1.</Text>
          <Text style={styles.textBoldHostDomits}>List your property</Text>
          <Text style={styles.text}>
            Start earning by listing your property for free in just minutes.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
