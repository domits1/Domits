...
Screenshot evidence for issue #24 is stored under `docs/internal/qa/images/issue-24-performance-scalability/`.

| Evidence area | Screenshot references | Notes |
| --- | --- | --- |
| Frontend PageSpeed homepage | `docs/internal/qa/images/issue-24-performance-scalability/PagespeedResulst-mobile1.png`, `docs/internal/qa/images/issue-24-performance-scalability/PagespeedResulst-mobile2.png`, `docs/internal/qa/images/issue-24-performance-scalability/PagespeedResulst-mobile3.png`, `docs/internal/qa/images/issue-24-performance-scalability/Pagespeedresulst1.png`, `docs/internal/qa/images/issue-24-performance-scalability/Pagespeedresulst2.png`, `docs/internal/qa/images/issue-24-performance-scalability/Pagespeedresulst3.png` | PageSpeed evidence for homepage mobile and desktop runs. |
| Frontend PageSpeed search/listings | `docs/internal/qa/images/issue-24-performance-scalability/PagespeedHome-Mobile.png`, `docs/internal/qa/images/issue-24-performance-scalability/PagespeedHome-Desktop.png` | PageSpeed evidence for `https://www.domits.com/home`. |
| Frontend PageSpeed listing detail | `docs/internal/qa/images/issue-24-performance-scalability/PagespeedListingPage-Mobile.png`, `docs/internal/qa/images/issue-24-performance-scalability/PagespeedListingPage-Desktop.png` | PageSpeed evidence for the known active listing detail URL. |
| GTmetrix homepage | `docs/internal/qa/images/issue-24-performance-scalability/GTmetrixsummary.png`, `docs/internal/qa/images/issue-24-performance-scalability/GTmetrixPerformance.png`, `docs/internal/qa/images/issue-24-performance-scalability/GTmetrixStructure.png` | GTmetrix evidence for the homepage only. |
| CloudWatch controlled k6 test | `docs/internal/qa/images/issue-24-performance-scalability/PropertyAPIgateway-Test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingAPIgateway-Test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/PropertyLambda-test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingsLambda-test1.png` | CloudWatch evidence is screenshot/dashboard-based. No exported numeric CloudWatch metrics were used. |
...
| --- | --- | --- | --- | --- |
| API Gateway `Latency` | Yes | Latency visible for Property and Booking APIs. CloudWatch showed small expected latency activity around the controlled k6 test window. | `docs/internal/qa/images/issue-24-performance-scalability/PropertyAPIgateway-Test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingAPIgateway-Test1.png` | Region: Europe (Stockholm) / `eu-north-1`. Evidence is screenshot/dashboard-based; no exported numeric CloudWatch metrics were used. |
| API Gateway `IntegrationLatency` | Yes | IntegrationLatency visible for Property and Booking APIs. CloudWatch showed small expected integration latency activity around the controlled k6 test window. | `docs/internal/qa/images/issue-24-performance-scalability/PropertyAPIgateway-Test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingAPIgateway-Test1.png` | No concurrency/stress conclusion should be made from this controlled low-volume run. |
| API Gateway `4XXError` | Yes | 4XXError included in API Gateway graphs. Earlier `byType?type=Boat` curl testing returned 10/10 HTTP 404, but that endpoint was excluded from the controlled k6 run. | `docs/internal/qa/images/issue-24-performance-scalability/PropertyAPIgateway-Test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingAPIgateway-Test1.png` | The earlier 404 result should be treated as invalid benchmark parameter or endpoint/routing/data issue. |
| API Gateway `5XXError` | Yes | 5XXError included in API Gateway graphs. No clear 5XX errors were observed in the reviewed screenshots. | `docs/internal/qa/images/issue-24-performance-scalability/PropertyAPIgateway-Test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingAPIgateway-Test1.png` | Not confirmed numerically from exported metric data. |
| API Gateway `Count` | Yes | Count visible for Property and Booking API metrics. | `docs/internal/qa/images/issue-24-performance-scalability/PropertyAPIgateway-Test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingAPIgateway-Test1.png` | Controlled k6 run used 318 HTTP requests across the read-only endpoints. |
| Lambda `Duration` | Yes | Duration checked for Property and Bookings Lambda metrics. CloudWatch showed small expected duration activity around the controlled k6 test window. | `docs/internal/qa/images/issue-24-performance-scalability/PropertyLambda-test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingsLambda-test1.png` | Evidence is screenshot/dashboard-based; no exported numeric CloudWatch metrics were used. |
| Lambda `Errors` | Yes | Errors checked for Property and Bookings Lambda metrics. No clear Lambda errors were observed in the reviewed screenshots. | `docs/internal/qa/images/issue-24-performance-scalability/PropertyLambda-test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingsLambda-test1.png` | Not confirmed numerically from exported metric data. |
| Lambda `Throttles` | Yes | Throttles checked for Property and Bookings Lambda metrics. No throttles were observed in the reviewed screenshots. | `docs/internal/qa/images/issue-24-performance-scalability/PropertyLambda-test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingsLambda-test1.png` | Not confirmed numerically from exported metric data. |
| Lambda `ConcurrentExecutions` | Yes | ConcurrentExecutions checked for Property and Bookings Lambda metrics. | `docs/internal/qa/images/issue-24-performance-scalability/PropertyLambda-test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingsLambda-test1.png` | Controlled k6 run used max 5 VUs; this does not prove scalability or capacity. |
...
| No throttles | No Lambda throttles were observed in the reviewed CloudWatch screenshots for the controlled k6 run; no numeric export was provided | Passed visually / Not confirmed numerically | `docs/internal/qa/images/issue-24-performance-scalability/PropertyLambda-test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingsLambda-test1.png`; controlled load CloudWatch notes | Marked carefully because this is screenshot/dashboard-based evidence only. |
| No 5XX errors | k6 reported 0.00% failed requests and all endpoint checks returned HTTP 200. No clear 5XX errors were observed in the reviewed API Gateway screenshots; no numeric export was provided. | Passed visually / Not confirmed numerically | Controlled k6 load test results; `docs/internal/qa/images/issue-24-performance-scalability/PropertyAPIgateway-Test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingAPIgateway-Test1.png` | Successful k6 endpoints returned no 5XX. Earlier `byType?type=Boat` returned 404, not 5XX, and was excluded from the k6 run. |
...
- Screenshot references: `docs/internal/qa/images/issue-24-performance-scalability/PropertyAPIgateway-Test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingAPIgateway-Test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/PropertyLambda-test1.png`, `docs/internal/qa/images/issue-24-performance-scalability/BookingsLambda-test1.png`.
