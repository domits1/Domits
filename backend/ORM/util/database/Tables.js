...
// Review: Registers review workflow entities with the ORM database connection.
...
import { Review_Notification_Preference } from "../../models/Review_Notification_Preference.js";
...
export const Tables = [
  ...
  // Review: Enables repository access to review storage, workflow, moderation, and notification tables.
  Review,
  Review_Rating,
  Review_Category,
  Review_Request,
  ...
  Review_Moderation,
  Review_Verification,
  Review_Notification_Preference,
];
