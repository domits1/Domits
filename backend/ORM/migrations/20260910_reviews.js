// Review: Creates the base review and per-category rating tables in test and main schemas.
export class Reviews20260910 {
  async up(queryRunner) {
    // Review: Builds the first review storage tables and lookup indexes.
  ...
  async down(queryRunner) {
    // Review: Removes the base review storage tables created by this migration.
