...
// Review: Converts moderation timestamps from bigint storage into JS numbers.
...
export const Review_Moderation = new EntitySchema({
  // Review: Records each review moderation decision, reason, notes, and moderator actor.
