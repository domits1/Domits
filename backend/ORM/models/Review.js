...
// Review: Converts database numeric strings into numbers for review timestamps and ratings.
...
export const Review = new EntitySchema({
  // Review: Main guest review record tied to a booking, property, host, and publication workflow.
  name: "Review",
  tableName: "review",
  columns: {
