...
// Review: Converts review request workflow timestamps between bigint storage and JS numbers.
...
export const Review_Request = new EntitySchema({
  // Review: Tracks review invitations, reminder timing, completion, suppression, and worker claims.
  name: "Review_Request",
  ...
  columns: {
    ...
    sendCount: { name: "send_count", type: "int", nullable: false, default: 0 },
    lastSentAt: { name: "last_sent_at", type: "bigint", nullable: true, transformer: bigintTransformer },
    nextSendAt: { name: "next_send_at", type: "bigint", nullable: true, transformer: bigintTransformer },
    claimedAt: { name: "claimed_at", type: "bigint", nullable: true, transformer: bigintTransformer },
    createdAt: {
      name: "created_at",
      type: "bigint",
      nullable: false,
