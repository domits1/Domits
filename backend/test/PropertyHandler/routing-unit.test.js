...
const directRouteSpecs = [
  ...
  ["POST website custom domain request", "requestWebsiteCustomDomain", "POST", "/property/website/site/domain/custom", 200],
  ["POST website custom domain recheck request", "recheckWebsiteCustomDomain", "POST", "/property/website/site/domain/custom/recheck", 200],
  ["POST website custom domain activate request", "activateWebsiteCustomDomain", "POST", "/property/website/site/domain/custom/activate", 200],
  ["POST website custom domain deactivate request", "deactivateWebsiteCustomDomain", "POST", "/property/website/site/domain/custom/deactivate", 200],
