...
export const MessagingPreference = new EntitySchema({
  ...
  columns: {
    ...
    dailyReminderEnabled: { type: "boolean", nullable: false, default: false },
    dailyReminderTime: { type: "time", nullable: true },
    dailyReminderTimezone: { type: "varchar", nullable: true },
