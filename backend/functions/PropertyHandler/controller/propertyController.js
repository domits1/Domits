...
export class PropertyController {
  ...
  async createImageUploadUrls(event) {
    try {
      ...
      if (files.length > 60 || existingCount + files.length > 60) {
        return this.badRequest("Maximum of 60 images allowed.");
      }
  ...
  validateRulesPayload(rules) {
    ...
    if (hasInvalidRuleEntry) {
      return "Rules must contain { rule: string, value: string|boolean }.";
    }
    return null;
  }
