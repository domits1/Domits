...
export class PropertyAvailability {
    ...
    set _property_id(id) {
        if (typeof id !== "string") {
            throw new TypeException("propertyAvailability - Property id must be a string.")
        }
        this.property_id = id;
    }
    ...
    set _availableStartDate(value) {
        if (typeof value !== "number") {
            throw new TypeException("propertyAvailability - Available start date must be a number.")
        }
    ...
    set _availableEndDate(value) {
        if (typeof value !== "number") {
            throw new TypeException("propertyAvailability - Available end date must be a number.")
        }
