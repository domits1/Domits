...
const AccommodationCard = ({ accommodation, onClick }) => {
  ...
  return (
    <div className="accocard" key={accommodation.property?.id} onClick={(e) => onClick(e, accommodation.property?.id)}>
      ...
      <div className="accocard-content">
        ...
        <div className="accocard-detail">{accommodation.property?.description || "No description available"}</div>
