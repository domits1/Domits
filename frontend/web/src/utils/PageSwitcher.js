                    ...
                    <div className={styles.listingButtonBox}>
                        ...
                        {accommodation.Drafted === true ? (
                            <button
                                ...
                                disabled={!(bankDetailsProvided && accommodation.DateRanges && accommodation.DateRanges.length > 0)}
                                style={{ backgroundColor: !(bankDetailsProvided && accommodation.DateRanges && accommodation.DateRanges.length > 0) ? 'gray' : '#003366', fontSize: '0.8rem' }}
                            >
                                Set Live
                            </button>
                        ) : (
