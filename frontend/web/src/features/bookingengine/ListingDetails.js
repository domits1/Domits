  ...
  useEffect(() => {
    const calculateTotal = () => {
      ...
      const calculatedTotalPrice =
        basePrice + calculatedServiceFee + cleaningFee + calculatedVatRate + calculatedTouristTaxRate;
          ...
          {accommodation && (
            <div>
              ...
              <div>
                ...
                {showModal && <FeaturePopup features={accommodation.Features} onClose={toggleModal} />}
                    ...
                    <div ref={popupRef} className="dropdown-content">
                      <div className="counter">
                        ...
                        <div className="button__box">
                          <button onClick={() => setAdults(Math.max(adults - 1, 0))} disabled={adults <= 0}>
                            -
                          </button>
                      ...
                      <div className="closeButtonContainer">
                        <p onClick={() => setShowGuestPopup(false)} className="closeButton">
                          Close
                        </p>
                      </div>
                    </div>
