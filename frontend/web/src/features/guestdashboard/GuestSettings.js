...
const GuestDashboard = () => {
  ...
  const [user, setUser] = useState({ email: "", name: "", address: "", phone: "", family: "", userId: "" });
            ...
            <div className="InfoBox">
              ...
              {editState.phone ? (
                <div style={{ display: "flex", gap: "5px", alignItems: "center" }}>
                  ...
                  />
                  <div onClick={saveUserPhone} className="edit-icon-background">
              ...
              <div onClick={() => toggleEditState("phone")} className="edit-icon-background">
