...
// make sure you still have this import in your file:
// import { listAccommodations as listAccommodationsQuery } from "../../graphql/queries";

const SETTINGS_CARDS = [
  {
    key: "personal",
    title: "Personal information",
    description: "Provide your personal information so we can reach you.",
  },
  {
    key: "notifications",
    title: "Notifications",
  ...
  },
  {
    ...
    description: "Review payments, payouts, and coupons.",
  },
  {
    key: "language",
    title: "Language & Currency",
    description: "Choose a default language and default currency.",
  },
];
...
const GuestDashboard = () => {
  ...
  const saveUserPhone = async () => {
    try {
      ...
      const response = await fetch(
        "https://24oly7cicg.execute-api.eu-north-1.amazonaws.com/default/General-CustomerIAM-Production-Update-PhoneNumber",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      <div className="settings-grid">
        {SETTINGS_CARDS.map((item) => (
          <button
            ...
            className={
              "settings-card" +
              (activeSection === item.key ? " settings-card--active" : "")
            }
            onClick={() => setActiveSection(item.key)}
          >
            <span className="settings-card-icon">
              {/* placeholder icon – replace with real svg/icon if you want */}
              <span className="settings-card-icon-dot" />
            </span>
      ...
      <div className="settings-detail">
        ...
        {activeSection === "notifications" && (
          <div className="settings-placeholder">
            <h3>Notifications</h3>
            <p>
              Notification settings will go here (email, SMS, push preferences,
              etc.).
            </p>
          </div>
        )}
        ...
        {activeSection === "login" && (
          <div className="settings-placeholder">
            ...
            <p>Password change, 2FA, and device management UI can come here.</p>
          </div>
        )}
        ...
        {activeSection === "privacy" && (
          <div className="settings-placeholder">
            ...
            <p>Data sharing and privacy controls go here.</p>
          </div>
        )}
        ...
        {activeSection === "payments" && (
          <div className="settings-placeholder">
            ...
            <p>Cards, bank accounts, and payout settings UI can go here.</p>
          </div>
        )}
        ...
        {activeSection === "language" && (
          <div className="settings-placeholder">
            ...
            <p>Default language and currency selectors go here.</p>
          </div>
        )}
      </div>
    </div>
