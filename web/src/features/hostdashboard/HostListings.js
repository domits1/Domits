...
function HostListings() {
  ...
  const asyncChangeAccommodationStatus = async (id, drafted) => {
    ...
    if (
      confirm(`Do you wish to set this accommodation as ${status}?`) === true
    ) {
      const options = {
        ID: id,
        Status: drafted,
      ...
      try {
        const response = await fetch(
          'https://ms26uksm37.execute-api.eu-north-1.amazonaws.com/dev/ChangeAccommodationStatues',
          {
            method: 'PUT',
            ...
            <div className={styles.listingBody}>
              ...
              <section className={styles.listingsDisplay}>
                ...
                {isLoading ? (
                  ...
                  <div>
                    <p>
                      It appears that you have not drafted any accommodations
                      yet...
                    </p>
                  </div>
                )}
