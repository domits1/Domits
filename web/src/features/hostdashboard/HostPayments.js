...
function HostReports() {
  ...
  const handleExport = reportType => {
    const month = selectedDates[reportType].toLocaleString('default', {
      month: 'long',
    })
            ...
            <div className="reportsSection">
              ...
              <div className="overview">
                ...
                <div className="summary">
                  <h4>May Summary</h4>
                  <p>
                    Recognized revenue: ${revenueData.recognized_revenue / 100}
                  </p>
              ...
              <div className="reportBox">
                ...
                <p>
                  Export detailed journal entries for all debits and credits...
                </p>
                <DatePicker
                ...
                <button
                  ...
                  onClick={() => handleExport('journalEntries')}>
                  Export
                </button>
              </div>
              <div className="reportBox">
                ...
                <button
                  className="exportButton"
                  onClick={() => handleExport('balanceSheets')}>
                  Export
                </button>
              </div>
              <div className="reportBox">
                ...
                <button
                  className="exportButton"
                  onClick={() => handleExport('incomeStatements')}>
                  Export
                </button>
              </div>
              <div className="reportBox">
                ...
                <button
                  className="exportButton"
                  onClick={() => handleExport('waterfallCharts')}>
                  Export
                </button>
              </div>
              <div className="reportBox">
                ...
                <button
                  className="exportButton"
                  onClick={() => handleExport('arAgeingReports')}>
                  Export
                </button>
              </div>
            </div>
