        ...
        const fetchData = async () => {
            ...
            try {
                ...
                if (bookingData?.property_id) {
                    console.log('Fetching accommodation details for booking ID:', bookingData.property_id);
                    const accoRes = await fetch(`https://wkmwpwurbc.execute-api.eu-north-1.amazonaws.com/default/property/bookingEngine/listingDetails?property=${bookingData.property_id}`, {
                        method: 'GET',
                        headers: {
