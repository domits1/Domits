    ...
    <div className="onboarding-host-div">
      <main className="page-body">
        ...
        <section className="acco-location-map">
          <InteractiveMap initialCoords={initialCoords} onLocationSelect={handleLocationUpdate} />
        </section>
        ...
        <nav className="onboarding-button-box">
          <Button routePath={`/hostonboarding/${accommodationType}/title`} btnText="Go back" variant="secondary" />
          <Button
