    ...
    if (isCompleted) {
      ...
      try {
        const response = await fetch(
          `https://slixu87at0.execute-api.eu-north-1.amazonaws.com/default/CreateReview`,
          {
            method: 'POST',
            headers: {
          ...
          <main className={styles.main}>
            ...
            <section className={styles.content}>
              <label htmlFor="content">
                Do you have any feedbacks? (not required)
              </label>
              <textarea
                className={styles.textarea}
                name="Content"
