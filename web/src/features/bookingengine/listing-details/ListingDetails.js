...
import { setDates, restrictCheckOutToDateRange, restrictCheckInToDateRange } from './dateUtils';
...
const ListingDetails = () => {
    ...
    useEffect(() => {
        setDates(StartDate, EndDate, bookedDates, setMinStart, setMaxStart, setMinEnd, setMaxEnd, setBookedDates);
    }, [StartDate, EndDate, bookedDates]);
    
    useEffect(() => {
        restrictCheckOutToDateRange(checkIn, accommodation, setMaxEnd);
    }, [checkIn]);
    
    useEffect(() => {
        restrictCheckInToDateRange(checkOut, accommodation, setMinStart);
    }, [checkOut]);
