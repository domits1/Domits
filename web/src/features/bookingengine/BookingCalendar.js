    ...
    for (let i = 1; i <= endDate; i++) {
      ...
      if (checkIn === null && checkOut === null) {
        ...
        minAdvanceReservation.setDate(
          today.getDate() + passedProp.MinimumAdvanceReservation,
        )
        minAdvanceReservation.setHours(0, 0, 0, 0)

        const maxAdvanceReservation = normalizeDate(new Date())
        maxAdvanceReservation.setDate(
          today.getDate() + passedProp.MaximumAdvanceReservation,
        )
        maxAdvanceReservation.setHours(0, 0, 0, 0)

        isOutsideAdvanceRange =
          currentDate < minAdvanceReservation ||
          currentDate > maxAdvanceReservation
        ...
        isOutsideAdvanceRange =
          currentDate < minStayDate || currentDate > maxStayDate
      }
      ...
      if (
        ...
        isWithinRange =
          checkIn && checkOut && isDateInRange(currentDate, checkIn, checkOut)
      } else if (
        passedProp.MinimumStay !== 0 &&
        passedProp.MaximumStay === 0 &&
        passedProp.MinimumAdvanceReservation === 0 &&
        ...
        isFiltered =
          isPastDate || currentDate < minStayDate || !filter(currentDate)
        isStartDate = isSameDay(checkIn, currentDate)
        isEndDate = isSameDay(checkOut, currentDate)
        isWithinRange =
          checkIn && checkOut && isDateInRange(currentDate, checkIn, checkOut)
        ...
        if (checkIn !== null) {
          ...
          isFiltered =
            isPastDate || currentDate < maxStayDate || !filter(currentDate)
        }
        isStartDate = isSameDay(checkIn, currentDate)
        isEndDate = isSameDay(checkOut, currentDate)
        isWithinRange =
        ...
        isFiltered =
          isPastDate || currentDate < minAdvanceDate || !filter(currentDate)
        isStartDate = isSameDay(checkIn, currentDate)
        isEndDate = isSameDay(checkOut, currentDate)
        isWithinRange =
          checkIn && checkOut && isDateInRange(currentDate, checkIn, checkOut)
        ...
        isFiltered =
          isPastDate || currentDate > maxAdvanceDate || !filter(currentDate)
        isStartDate = isSameDay(checkIn, currentDate)
        isEndDate = isSameDay(checkOut, currentDate)
        isWithinRange =
          checkIn && checkOut && isDateInRange(currentDate, checkIn, checkOut)
