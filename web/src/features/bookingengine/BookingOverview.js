...
const stripePromise = loadStripe(
  "pk_live_51OAG6OGiInrsWMEcQy4ohaAZyT7tEMSEs23llcw2kr2XHdAWVcB6Tm8F71wsG8rB0AHgh4SJDkyBymhi82WABR6j00zJtMkpZ1",
);
...
const BookingOverview = () => {
  ...
  const initiateStripeCheckout = async () => {
    ...
    const totalAmount = Math.round(
      basePrice + cleaningFee * 100 + ServiceFee * 100 + taxes * 100,
    );
    ...
    try {
      const response = await fetch(
        "https://3zkmgnm6g6.execute-api.eu-north-1.amazonaws.com/dev/create-checkout-session",
        {
          method: "POST",
  ...
  return (
    <main
      ...
      style={{ cursor: isProcessing ? "wait" : "default" }}
    >
          ...
          <div className="booking-details">
            <div className="detail-row">
              ...
              <span className="detail-value">
                {DateFormatterDD_MM_YYYY(checkIn)} -{" "}
                {DateFormatterDD_MM_YYYY(checkOut)}
              </span>
            </div>
            <div className="detail-row">
              <span className="detail-label">
          ...
          <div className="left-panel">
            <div className="booking-details-name">
              <img
                ...
                src={
                  accommodation.Images && Object.values(accommodation.Images)[0]
                }
                alt="Accommodation"
              />
              <div>
