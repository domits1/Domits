...
const Register = () => {
  ...
  const onSubmit = async e => {
    e.preventDefault()
    const {username, email, password, firstName, lastName, phone, countryCode} =
      formData
    ...
    if (!hasUppercase && !hasNumber) {
      setErrorMessage(
        'Password must contain at least one uppercase letter or one number.',
      )
      setPasswordShake(true)
      return
    }
          ...
          <form onSubmit={onSubmit} className="registerForm">
            ...
            <div className="passwordContainer">
              <input
                ...
                style={{
                  borderColor: errorMessage.includes('Password')
                    ? 'red'
                    : 'var(--secondary-color)',
                }}
              />
            ...
            <div className="alreadyAccountText">
              ...
              <a href="/web/src/features/auth/Login">Log in here</a>
            </div>
            {errorMessage && <div className="errorText">{errorMessage}</div>}
            <button
              type="submit"
              className="registerButton"
              onClick={() => setShouldShake(true)}>
              Sign Up
            </button>
          </form>
        </div>
