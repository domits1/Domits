  ...
  return (
    <Grid
      ...
      <TextField
        ...
        {...getOverrideProps(overrides, 'userId')}></TextField>
      <TextField
        label="Recipient id"
        isRequired={false}
        isReadOnly={false}
        ...
        {...getOverrideProps(overrides, 'recipientId')}></TextField>
      <TextField
        label="Text"
        isRequired={true}
        isReadOnly={false}
        ...
        {...getOverrideProps(overrides, 'text')}></TextField>
      <TextField
        label="Email"
        isRequired={false}
        isReadOnly={false}
      ...
      <TextField
        ...
        {...getOverrideProps(overrides, 'recipientEmail')}></TextField>
      <SwitchField
        label="Is read"
        ...
        {...getOverrideProps(overrides, 'isRead')}></SwitchField>
      <TextField
        label="Sort key"
        isRequired={false}
        isReadOnly={false}
        ...
        {...getOverrideProps(overrides, 'sortKey')}></TextField>
      <TextField
        label="Created at"
        isRequired={false}
        isReadOnly={false}
      ...
      <TextField
        ...
        {...getOverrideProps(overrides, 'channelID')}></TextField>
      <Flex
