...
export declare type AccommodationUpdateFormProps = React.PropsWithChildren<
  {
    ...
    accommodation?: any
    onSubmit?: (
      fields: AccommodationUpdateFormInputValues,
    ) => AccommodationUpdateFormInputValues
...
>
export default function AccommodationUpdateForm(
  props: AccommodationUpdateFormProps,
): React.ReactElement
