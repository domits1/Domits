...
export declare type AccommodationCreateFormProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: AccommodationCreateFormInputValues) => AccommodationCreateFormInputValues;
    onSuccess?: (fields: AccommodationCreateFormInputValues) => void;
    onError?: (fields: AccommodationCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: AccommodationCreateFormInputValues) => AccommodationCreateFormInputValues;
    onValidate?: AccommodationCreateFormValidationValues;
} & React.CSSProperties>;
export default function AccommodationCreateForm(props: AccommodationCreateFormProps): React.ReactElement;
