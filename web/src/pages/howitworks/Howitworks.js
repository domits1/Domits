  ...
  return (
    <section className="howitworks__main">
      <article className="howitworks__titles-container">
        ...
        <h5 className="howitworks__subtitle">
          Discover how Domits makes it easy for both guests and hosts.
        </h5>
      </article>
      ...
      <article className="howitworks__info-block howitworks__info-block--guests">
        <section className="howitworks__info-item howitworks__info-item--guests borderright">
          ...
          <p className="howitworks__info-text">
            Explore countless vacation rentals with Domits’ user-friendly search
            filters. Customize your search by location, date, and amenities to
        ...
        <section className="howitworks__info-item howitworks__info-item--guests">
          ...
          <p className="howitworks__info-text">
            Secure your dream stay with Domits now! Choose your preferred
            accommodation and book in just a few clicks.
          </p>
        </section>
        <section className="howitworks__info-item howitworks__info-item--guests borderleft">
          ...
          <p className="howitworks__info-text">
            Unlimited support, personalized modern dashboard and messaging with
      ...
      <article className="howitworks__info-block howitworks__info-block--hosts bluebackground">
        <section className="howitworks__info-item howitworks__info-item--hosts borderright">
          <div className="howitworks__info-header">
            <h3 className="howitworks__info-title">
              List your property for rental
            </h3>
            <FontAwesomeIcon icon={faUser} fontSize={'1.7rem'} color="white" />
          </div>
          <p className="howitworks__info-text">
            List your property in a few simple steps. Add photos, describe your
            property, set your price and share availability.
          </p>
        </section>
        <section className="howitworks__info-item howitworks__info-item--hosts">
          <div className="howitworks__info-header">
            <h3 className="howitworks__info-title">
              Get paid easy, fast and safe
            </h3>
            <FontAwesomeIcon
              icon={faCalendarAlt}
              fontSize={'1.7rem'}
          ...
          <p className="howitworks__info-text">
            Connect your details to our payment system and get paid. Oversee
            your occupancy, revenue management, reports and average daily rate.
          </p>
        </section>
        <section className="howitworks__info-item howitworks__info-item--hosts borderleft">
          ...
          <p className="howitworks__info-text">
            Give your guests a warmhearted welcome. Manage your properties,
            calendars, reservations, messages and much more.
          </p>
        </section>
      </article>
      ...
      <article className="howitworks__titles-container">
        ...
        <h4>
          Increase revenue, reduce workload, deliver beautiful experiences
        </h4>

        <div className="HostContainer">
          <div>
            <p>
              <span className="span">#1: Core Feature.</span>
            </p>
            <p>
              <span className="span">#2: Performance Bundles.</span> Digital
              Growth, Revenue, Operations, Guest Experience. 
            </p>
            <p>
              <span className="span">#3: Education & Support.</span> 9-5 mo-fr
              support, onboarding solutions, account team, Community.
            </p>
          </div>
        </div>
