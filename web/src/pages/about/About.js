    ...
    <div className="about__crew">
      ...
      <div className="about__team">
        ...
        {[
          ...
          .map((member) => (<div className="about__member" key={member.name}>
            <div className="about__avatar">
      ...
      <h2>Marketing</h2>
      <div className="about__team">
        {[{name: 'Jared', src: Jared, role: 'Growth'}, {name: 'Ali', src: standard, role: 'Growth'}, {
          name: 'Maroan',
          src: standard,
          role: 'Growth',
        ...
        {[...Array(3)].map((_, i) => (<div className="about__member" key={`hiring-${i}`}>
          <div className="about__avatar">
