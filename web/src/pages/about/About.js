    ...
    <div className="about">
      <div className="about__title-container">
        <h2 className="about__title">
          <span className="highlightH2">About Domits</span>
        </h2>
      ...
      <div className="about__text-container">
        <p className="about__text about__text--margintop">
          In our growing traveltech network are young professionals,
          influencers, traveltechs, companies and partners. There are also
          talent pools with students from IT, Data Science, Cyber ​​Security,
          AI, ML, Marketing and IT law.
        </p>
      ...
      <div className="about__factsbox">
        <div className="about__fact">
          ...
          <p className="about__fact-subtitle">
            A healthy, safe and future-proof travel world
          </p>
          <p className="about__fact-text">
            Our vision is a travel world that has less problems with health,
            safety and future-proofing. Now and in the future, that is what
            Domits has in mind. Everyone takes into account how people deal with
            these problems and their options. Together with partners, we work
            every day to simplify travel.
          </p>
        </div>
        <div className="about__fact">
          <div className="about__fact-header">
            ...
            <img
              className="about__fact-image"
              src={whatwedo}
              alt="What we do"
            />
          </div>
          <p className="about__fact-subtitle">
            Together with partners we provide travel solutions
          </p>
          <p className="about__fact-text">
            We build our travel platform to list, search and book
            accommodations. Besides that we are providing traveltech development
            and consultancy for a select group of partners. We are open to
            cooperate through ventures and our{' '}
      ...
      <div className="about__crew">
        ...
        <div className="about__team">
          ...
          {[
            ...
            {name: 'Ryan', src: standard, role: 'Developer'},
        ...
        <div className="about__footer">
          <p className="about__footer-text">
            We believe that every employee can be a conscious founder. And you
            are allowed to think and act that way. A conscious founder is an
            entrepreneur who makes decisions based on health, safety and
            future-proofing. For themselves, the organization, customers,
            partners and society.
          </p>
          <p className="about__footer-text">
            You take responsibility. Discovers new ways to get things done. And
            comes up with new ideas and solutions. You want to create, build and
            develop together. We are always looking for new founders.
          </p>
        </div>
      </div>
    </div>
