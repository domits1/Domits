...
class Calculator extends Component {
        ...
        return (
          <div>
            ...
            <div className={styles.buttonHolder}>
              ...
              <button
                className={styles.nextButtons}
                onClick={() => this.pageUpdater(page + 1)}>
                Next
              </button>
            </div>
          </div>
      ...
      case 2:
        return (
          <div>
            ...
            <div className={styles.cardHolder}>
              {this.renderCard(0, '< 25m²', null, selectedCards[2] === 0, 0.8)}
              {this.renderCard(
                1,
                '25 - 50 m²',
                null,
        ...
        return (
          <div>
            ...
            <div className={styles.cardHolder}>
              ...
              {this.renderCard(1, '2', null, selectedCards[3] === 1, 1.5)}
              {this.renderCard(2, '3', null, selectedCards[3] === 2, 2)}
              {this.renderCard(3, '4', null, selectedCards[3] === 3, 2.5)}
              ...
              <button
                ...
                onClick={
                  this.areAllCardsSelected()
                    ? () => this.pageUpdater(page + 1)
                    : null
                }
                style={{
                  backgroundColor: 'green',
                  cursor: this.areAllCardsSelected()
                    ? 'pointer'
                    : 'not-allowed',
          ...
          <div>
            ...
            <div className={styles.infoHolder}>
              ...
              <p className={styles.info}>
                Property Type: {this.displayInfo(1)}
              </p>
              <p className={styles.info}>Measurements: {this.displayInfo(2)}</p>
              <p className={styles.info}>
                Sleeping Places: {this.displayInfo(3)}
              </p>
              <p className={styles.info}>Service fees: 12%</p>
              <p>
                If this estimation interests you, please consider hosting on
                Domits!
              </p>
            </div>
            <div className={styles.buttonHolder}>
  ...
  calculatePrice = () => {
    ...
    const totaal =
      priceIndicator[1] * priceIndicator[2] * priceIndicator[3] * 0.88
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className={styles.page}>{this.renderPageContent(page)}</div>
      </div>
    )
  }
}
