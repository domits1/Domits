              ...
              <div>
                <h2 className="onboardingSectionTitle">
                  {isNew
                    ...
                    : 'Change the type of boat that you own'}
                </h2>
              ...
              <div>
                <h2 className="onboardingSectionTitle">
                  {isNew
                    ...
                    : 'Change the type of camper that you own'}
                </h2>
                <section className="accommodation-types">
              ...
              <section className="guest-access">
                <h2 className="onboardingSectionTitle">
                  {isNew
                    ...
                    : 'Change the type of access your guests can have'}
                </h2>
                <div
                  className={
      ...
      case 2:
        return (
          <main className="page-body">
            <h2 className="onboardingSectionTitle">
              {isNew
                ? `Where can we find your ${selectedAccoType === 'Boat' || selectedAccoType === 'Camper' ? selectedAccoType.toLowerCase() : 'accommodation'}?`
          ...
          <main className="container">
            <h2 className="onboardingSectionTitle">
              {isNew
                ...
                : 'Adjust the maximum amount of guests'}
            </h2>
            ...
            <div className="houseRulesContainer">
              <div className="toggle-container">
                <label className="toggle">
                  ...
                  <input
                    ...
                    onChange={e =>
                      handleHouseRulesChange('AllowSmoking', e.target.checked)
                    }
                  />
                ...
                <label className="toggle">
                  ...
                  <input
                    ...
                    onChange={e =>
                      handleHouseRulesChange('AllowPets', e.target.checked)
                    }
                  />
                  <div className="toggle-switch"></div>
                </label>
                ...
                <label className="toggle">
                  ...
                  <input
                    ...
                    onChange={e =>
                      handleHouseRulesChange('AllowParties', e.target.checked)
                    }
                  />
                  <div className="toggle-switch"></div>
                </label>
              ...
              <label className="Check">
                ...
                <select
                  ...
                  onChange={e =>
                    handleHouseRulesChange('CheckIn', e.target.value, 'From')
                  }>
                ...
                <select
                  ...
                  onChange={e =>
                    handleHouseRulesChange('CheckIn', e.target.value, 'Til')
                  }>
                  {Array.from({length: 24}, (_, i) => {
                    const time = i.toString().padStart(2, '0') + ':00'
                    return (
              ...
              <label className="Check">
                ...
                <select
                  ...
                  onChange={e =>
                    handleHouseRulesChange('CheckOut', e.target.value, 'From')
                  }>
                  {Array.from({length: 24}, (_, i) => {
                    const time = i.toString().padStart(2, '0') + ':00'
                    return (
                ...
                <select
                  ...
                  onChange={e =>
                    handleHouseRulesChange('CheckOut', e.target.value, 'Til')
                  }>
                  {Array.from({length: 24}, (_, i) => {
                    const time = i.toString().padStart(2, '0') + ':00'
                    return (
      ...
      case 6:
        return (
          <main className="container">
            <h2 className="onboardingSectionTitle">
              {isNew
                ? `Add photos of your ${selectedAccoType.toLowerCase()}`
                : `Edit photos of your ${selectedAccoType.toLowerCase()}`}
            </h2>
      ...
      case 7:
        return (
          <main className="container">
            <h2 className="onboardingSectionTitle">
              {isNew
                ? `Name your ${selectedAccoType.toLowerCase()}`
                : `Edit the name of your ${selectedAccoType.toLowerCase()}`}
            </h2>
            <p className="onboardingSectionSubtitle">
          ...
          <main className="container">
            ...
            <h2 className="acco-price">
              {!isNaN(parseFloat(formData.Rent))
                ? `€ ${parseFloat(formData.Rent).toFixed(0)}`
            ...
            <section className="accommodation-pricing">
              ...
              {formData.Features.ExtraServices.includes(
                ...
                <div className="pricing-row">
                  ...
                  <input
                    ...
                    onInput={handleInputRestrictions}
                    defaultValue={
                      formData.CleaningFee ? formData.CleaningFee : 1
                    }
                    min={1}
                    step={0.1}
                    required={true}
              ...
              <div className="pricing-row">
                ...
                <p className="pricing-input">
                  €
                  {(!isNaN(parseFloat(formData.ServiceFee))
                ...
                <p className="pricing-input">
                  ...
                  {(
                    (!isNaN(parseFloat(formData.Rent))
                      ...
                      : 0) +
                    (!isNaN(parseFloat(formData.CleaningFee))
      ...
      case 11:
        return (
          <div className="container" id="summary" style={{width: '80%'}}>
            ...
            {!Object.values(formData.Features).every(
              arr => arr.length === 0,
            ) && (
              <>
                <th>
            ...
            <p>
              {formData.Drafted
                ? 'Guests cannot book your accommodation before you set it live via Hostdashboard -> Listing'
