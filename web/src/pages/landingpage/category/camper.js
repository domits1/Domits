    ...
    <div className="camper-container">
      ...
      <div className="discover-container">
        ...
        <div className="discover-text">
          <p>
            Domits offers a range of campers with a story and a unique way of
            handling it.
          </p>
          <p>
            <img src={camperIcon} alt="camper icon" width={25} />
            Choose from a variety of campers to suit every need and budget.
          </p>
        </div>
        ...
        <div className="review-booking-test">
          ...
          <div className="booking-review">
            ...
            <div className="reviewer-content">
              ...
              <p>
                “A camper at the beach is just amazing, it feels like you own
