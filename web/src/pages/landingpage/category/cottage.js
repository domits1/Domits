        ...
        <div className='cottage-container'>
            ...
            <div className='cottage-header-container'>
                <div className='cottage-header-content'>
                  ...
                  <div className='cottage-header-button'>
                    <button type='text' className='host-button' onClick={() => navigateToHost}>Host your own cottage</button>
                  </div>
                </div>
            </div>
            ...
            <div className='discover-container'>
                ...
                <div className='discover-text'>
                    <p>Domits offers a range of cottages with a story and a unique way of handling it.</p>
                    <p><img src={camperIcon} alt='cottage icon' width={25}/>Choose from a variety of cottages to suit every need and budget.</p>
                </div>
                ...
                <div className='review-booking-test'>
                    ...
                    <div className='booking-review'>
                      ...
                      <div className='reviewer-content'>
                        ...
                        <p>“A cottage at the beach is just amazing, it feels like you own the beach, the sun and the water. Waking up with the sounds of the waves and ending your day with a sunset is just perfection in all ways!”</p>
