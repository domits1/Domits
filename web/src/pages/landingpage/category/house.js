    ...
    <div className="camper-container">
      ...
      <div className="discover-container">
        ...
        <div className="discover-text">
          <p>
            Domits offers a range of houses with a story and a unique way of
            handling it.
          </p>
          <p>
            <img src={camperIcon} alt="House icon" width={25} />
        ...
        <div className="review-booking-test">
          ...
          <div className="booking-review">
            ...
            <div className="reviewer-content">
              ...
              <p>
                “A house at the beach is just amazing, it feels like you own the
                beach, the sun and the water. Waking up with the sounds of the
                waves and ending your day with a sunset is just perfection in
                all ways!”
              </p>
