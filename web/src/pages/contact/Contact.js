    ...
    <div className="contact">
      <div className="contactFormContainer">
        ...
        <p>
          ...
          assist you! We always get back to you within 24 hours of reaching out.
          Not received any response from us yet? Check your spam inbox.
        </p>
        {feedbackMessage && (
          <p
      ...
      <div className="questionsContainer">
        ...
        <p className="quistionText">
          Do you have a question about a holiday accommodation, booking, or
          payment? Check our Frequently Asked Questions (FAQ). Domits is an
          intermediary so you rent the holiday accommodation from the host.
        </p>

        <h1>Are you a host, property owner, or manager?</h1>
        <p className="quistionText">
          We're always open for new holiday homes, boats, and campers. See on
          our hosting page how you can start within a couple of minutes for
          free. Or check our FAQ for hosts.
        </p>
        ...
        <h1>Contact</h1>
        <p className="quistionText">
          We are available to ensure optimal reachability across all time zones.
          The more specific you are in your reach out, the faster we can assist
          you! We always get back to you as soon as possible. Not received any
          response from us yet? Check your spam inbox.
        </p>
