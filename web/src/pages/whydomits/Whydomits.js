  ...
  return (
    <div className="aboutus">
      ...
      <div className="underbigtext">
        ...
        <p className="aboutText">
          Besides our traveltech network and talent, we are one of the fastest
          improving travel platforms. Although we only launched Domits in late
          2023, we have been supporting travel companies to grow since 2015.
        </p>
        <p className="aboutText">
