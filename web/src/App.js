              ...
              <div className="App">
                ...
                <Routes>
                  ...
                  <Route
                    ...
                    element={<PropertyGuestAmountView />}
                  />
                  <Route
                    path="/hostonboarding/:type/amenities"
                    element={<PropertyAmenitiesView />}
                  />
                  ...
                  <Route
                    ...
                    element={<PropertyHouseRulesView />}
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={<PropertyTitleView />}
                  />
                  <Route
                    path="/hostonboarding/:type/description"
                    element={<PropertyDescriptionView />}
                  />
                  <Route
                    path="/hostonboarding/:type/pricing"
                    element={<PropertyRateView />}
                  />
                  <Route
                    path="/hostonboarding/:type/availability"
                    element={<PropertyAvailabilityView />}
                  />
                  <Route
