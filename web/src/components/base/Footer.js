        ...
        <footer className='main-footer'>
            <div className='footer-content'>
                ...
                <div className="footer-section borderline">
                    ...
                    <ul className='footer-lists'>
                        <li><Link to="/home" className='footer-links'>Guests</Link></li>
                        <li><Link to="/landing" className='footer-links'>Hosts</Link></li>
                        <li><Link to="#" className='footer-links'>Developers</Link></li>
                        <li><Link to="#" className='footer-links'>Partners</Link></li>
                        <li><Link to="#" className='footer-links'>Students</Link></li>
                        <li><Link to="#" className='footer-links'>Startups</Link></li>
                    </ul>
                </div>
