    ...
    const renderPageContent = (page) => {
        switch (page) {
            ...
            case 2:
                return (
                    <section>
                        <article class="formContainer mBottom">
                            <article class="form-section">
                                <h2 className="onboardingSectionTitle">Add accomodation features</h2>
                                <article class="room-features formRow">
                                    <article>
