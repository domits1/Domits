    ...
    return (
        <div className="chat">
            ...
            <div className="input_container">
                <input type="text" className="input_field" placeholder="Type your message here..." />
                <button type="button" className="send_button">Send</button>
            </div>


            <span className="button_containerc">
            ...
            <span className="button_containerc"><button type="button" className="buttonc add-files-button">Add files</button></span>
            <span className="button_containerc"><button type="button" className="buttonc send-review-link">Send reviewlink</button></span>
