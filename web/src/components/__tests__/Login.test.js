...
describe('Login', () => {
    ...
    it('should display error message for invalid login credentials', async () => {
        Auth.signIn = jest.fn().mockRejectedValue(new Error('Invalid username or password'));
    ...
    it('should display error on network failure during login attempt', async () => {
        Auth.signIn = jest.fn().mockRejectedValue(new Error('Network Error'));
    ...
    it('should handle error when Auth.currentAuthenticatedUser throws an error', async () => {
        Auth.currentAuthenticatedUser = jest.fn().mockRejectedValue(new Error('Auth Error'));
