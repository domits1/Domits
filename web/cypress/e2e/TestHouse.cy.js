...
describe("House accomadation test", () => {
  it("should be able to add a listing", () => {
    ...
    cy.get("#root > div > main > nav > button:nth-child(2)").click();
    cy.get(
      "#root > div > main > section > div:nth-child(1) > div > button:nth-child(2)"
    ).then(($button) => {
      for (let i = 0; i < 1; i++) {
    ...
    cy.get(
      "#root > div > main > section > div:nth-child(2) > div > button:nth-child(2)"
    ).then(($button) => {
      for (let i = 0; i < 5; i++) {
        cy.wrap($button).click();
      }
    ...
    cy.get(
      "#root > div > main > section > div:nth-child(3) > div > button:nth-child(2)"
    ).then(($button) => {
      for (let i = 0; i < 3; i++) {
        cy.wrap($button).click();
      }
    ...
    cy.get(
      "#root > div > main > section > div:nth-child(4) > div > button:nth-child(2)"
    ).then(($button) => {
      for (let i = 0; i < 2; i++) {
        cy.wrap($button).click();
      }
    ...
    cy.get(
      "#root > div > main > div > div:nth-child(2) > section > label:nth-child(1) > input[type=checkbox]"
    ).click();
    ...
    cy.get('input[type="file"]')
      .eq(0)
      .selectFile("cypress/fixtures/image1.jpg");
    cy.get('input[type="file"]')
      .eq(1)
      .selectFile("cypress/fixtures/image2.jpg");
    cy.get('input[type="file"]')
      .eq(2)
      .selectFile("cypress/fixtures/image3.jpg");
    cy.get('input[type="file"]')
      .eq(3)
      .selectFile("cypress/fixtures/image4.jpg");
    cy.get('input[type="file"]')
      .eq(4)
      .selectFile("cypress/fixtures/image5.jpg"); // adding 5 images
    ...
    cy.get(":nth-child(3) > :nth-child(1) > .pricing-input").type(
      "10000100001000010000"
    );
    cy.get(":nth-child(2) > .pricing-input").type(
      "10000100001000010000100001000010000"
    );
    cy.get("#root > div > main > nav > button:nth-child(2)").click();

    cy.get(
      "#root > div > main > section > main > section > div.Calendar_calendar__7tYff > header > nav > button.Calendar_next__jcEfE"
    ).click(); // next month
    cy.get(
      "#root > div > main > section > main > section > div.Calendar_calendar__7tYff > section > ul.dates > li:nth-child(6)"
    ).click();
    cy.get(
      "#root > div > main > section > main > section > div.Calendar_calendar__7tYff > section > ul.dates > li:nth-child(6)"
    ).click();
    cy.get(
      "#root > div > main > section > main > section > div.Calendar_dateRanges__IGJzK > section > div"
    ).should("have.text", "01/11/2024 - 01/11/2024x"); // one day

    cy.get(
      "#root > div > main > section > main > section > div.Calendar_calendar__7tYff > section > ul.dates > li:nth-child(15)"
    ).click();
    cy.get(
      "#root > div > main > section > main > section > div.Calendar_calendar__7tYff > header > nav > button.Calendar_next__jcEfE"
    ).click();
    cy.get(
      "#root > div > main > section > main > section > div.Calendar_calendar__7tYff > section > ul.dates > li:nth-child(23)"
    ).click();
    cy.get(
      "#root > div > main > section > main > section > div.Calendar_dateRanges__IGJzK > section > div:nth-child(2)"
    ).should("have.text", "10/11/2024 - 23/12/2024x"); // To see if theres a second one and check if u can select differnt months

    cy.get(
      "#root > div > main > section > main > section > div.Calendar_calendar__7tYff > header > nav > button.Calendar_prev__wq3JJ"
    ).click();
    cy.get(
      "#root > div > main > section > main > section > div.Calendar_calendar__7tYff > header > nav > button.Calendar_prev__wq3JJ"
    ).click();
    cy.get(
      "#root > div > main > section > main > section > div.Calendar_calendar__7tYff > header > nav > button.Calendar_prev__wq3JJ"
    ).click(); // month before current month

    cy.get(
      "#root > div > main > section > main > section > div.Calendar_calendar__7tYff > section > ul.dates > li:nth-child(1)"
    ).click();
    cy.get(
      "#root > div > main > section > main > section > div.Calendar_calendar__7tYff > section > ul.dates > li:nth-child(1)"
    ).click();
    cy.get(
      "#root > div > main > section > main > section > div.Calendar_dateRanges__IGJzK > section > div:nth-child(3)"
    ).should("not.exist"); // To see if theres a second one and check if u can select differnt months

    cy.get("#root > div > main > nav > button:nth-child(2)").click();

    cy.get('[class*="registrationnumber-container"]').within(() => {
      cy.get("h2")
        .first()
        .then(($header) => {
          if ($header.text().includes("Registration number *")) {
            cy.log("Registration number is required");

            cy.get(
              "input[placeholder=\"For example: 'Abcd 1234 AB12 89EF A0F9'\"]"
            ).type("Abcd1234AB1289EFA0F9");

            cy.get('input[type="checkbox"]').check();
          } else if (
            $header.text().includes("Registration number (optional)")
          ) {
            cy.log("Registration number is optional");
          }
        });
    });
